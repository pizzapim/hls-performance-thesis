...
def main(repeats, count, lengths, dir, filenames):
    for filename in filenames:
        for length in lengths:
            benchmark(repeats, count, length, dir, filename)


def benchmark(repeats, count, length, dir, filename):
    ...
    gentestargs = ["./generate_test_data", textfilename, fmfilename, testfilename, f"{count}", f"{length}"]
...
if __name__ == "__main__":
    ...
    main(args.repeats, args.count, args.lengths, args.dir, args.files)
