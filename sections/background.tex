...
\citeauthor{paulino_optimizing_2020} also present a number of techniques to optimize OpenCL HLS performance, and compare its performance to both CPUs and GPUs \cite{paulino_optimizing_2020}.
